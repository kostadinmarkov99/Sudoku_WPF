...
namespace WpfApp4
{
    public class Sudoku : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Getters and Setters of the props: IsCheckedSolutionButton, IsUncheckedSolutionButton, GameStatistic, Difficulty, SolvedSudokuGames, StatisticString and MovesNumber
        /// </summary>
        ...
        /// <summary>
        /// Declaration and Gettes and Seeters of a Lists with the information of old values of each cell.
        /// </summary>
        #region Last Props and Getters and Setters
        ...
        /// <summary>
        /// Property, that checks is the game in progress
        /// </summary>
        private bool GameInProgress { get; set; }

        /// <summary>
        /// PropertyChanged EventHandler name
        /// </summary>
        public event PropertyChangedEventHandler PropertyChanged;

        /// <summary>
        /// Getters and setters of the Matrix, MatrixCopy, StartingMatrix and SolvedMatrix
        /// </summary>

        #region Matrix Getters and Setters
        ...
        /// <summary>
        /// Getter and Setter of the Moves Stack, used for the undo moves of the user
        /// </summary>
        ...
        /// <summary>
        /// Getter and Setter of the MovesRedo Stack, used for the redo moves of the user
        /// </summary>
        ...
        /// <summary>
        /// Getter and Setter of the MovesCopy Stack, used for the undo moves copy of the user
        /// </summary>
        ...
        /// <summary>
        /// Getter and Setter of the MovesRedoCopy Stack, used for the redo moves copy of the user
        /// </summary>
        ...
        /// <summary>
        ///Regex, used for fileter the information in the cells
        /// </summary>
        private static readonly Regex _regex = new Regex("[^0-9.-]+"); //regex that matches disallowed text

        /// <summary>
        /// Function, responsible for the uniqueness of the inputed number in a cell in this row and colum 
        /// </summary>
        ...
        /// <summary>
        /// Function, responsible for the uniqueness of the inputed number in a cell in mini rectangle
        /// </summary>
        ...
        /// <summary>
        /// Function, that cheks is the inputed information in the cells correnct
        /// </summary>
        ...
        /// <summary>
        /// Function, that checks is the matrix empty (used at the beginning to see is a game staarted)
        /// </summary>
        ...
        /// <summary>
        /// Properies for each cells, responsible for the binding of the cells and the changing of the number in each cell
        /// </summary>
        ...
        /// <summary>
        /// Check is the current cell's information for the binded isReadOnly property information
        /// </summary>
        ...
        /// <summary>
        /// Properies for each cells, responsible for the binding of the cells and the changing isReadOnly information in each cell
        /// </summary>
        #region
        ...
        /// <summary>
        /// Properies for each cells, responsible for the binded visibility and enability of the buttons
        /// </summary>
        ...
        /// <summary>
        /// Properies for each cells, responsible for the binded visibility of the mii rectangles
        /// </summary>
        #region
        ...
        /// <summary>
        /// Getters and Setters of the props IsEnabledCheckedButton, IsEnabledResetButton and IsEnabledPausedButton
        /// </summary>
        ...
        /// <summary>
        /// Function, that gets the isEnabled value of a specific cell
        /// </summary>
        ...
        /// <summary>
        /// Function, that creates a tupple with information, pushed in the Moves stack
        /// </summary
        ...
        /// <summary>
        /// Getters and Setters for IsEnabledXY, where X is the row number and the Y is the col number
        /// </summary>
        ...
        /// <summary>
        /// Getters and Setters for GetXY, where X is the row number and the Y is the col number
        /// </summary>
        ...
        /// Getters and Setters for GetXY, where X is the row number and the Y is the col number
        /// </summary>
        #region Pause And Resum Buttons Getters and Setters
        ...
        /// <summary>
        /// Getter and Setter of the isVisibleXYRectangle, where X is Top, Middle or Bottom, and Y is Left, Middle or Right
        /// </summary>
        #region Rectangles Visibility
        ...
        /// <summary>
        /// Function that returns an instance of the Sudoku class (Used in the App.xaml.cs file)
        /// </summary>
        public static Sudoku GetInstance(MainWindow window, SudokuMatrix sm)
        {
            if (_instance == null)                          // Is the instance variable null?
            {
                if (_instance == null)                  // Check again if the instance variable is null
                {
                    ...
                    _instance.InitSudoku(window, sm);        // Initialize it
                }
        ...
        /// <summary>
        /// Function that decided did the user click a number from the InputPad or the Clear button
        /// </summary>
        ...
        /// <summary>
        /// Function that clear the number in the cell, if the user has clicked the Clear Button from the InputPad
        /// </summary>
        private void ProccessClearCell(int row, int col)
        {
            string value = "";
            matrix[row, col] = value;    // Save user's answer
        ...
        /// <summary>
        /// Function that saves the number in the cell, if the user has clickeda number from the InputPad
        /// </summary>
        ...
        /// <summary>
        /// Initioalization function used at the beginning in the App.xaml.cs file
        /// </summary>
        private void InitSudoku(MainWindow window, SudokuMatrix sm)
        {
            this._view = window;
            this._sm = sm;
            hideGrid();
        ...
        /// <summary>
        /// Function for the initioalization of the property ElapsedTime with the information for ElapsedTime from GameTimerEventArgs
        /// </summary>
        ...
        /// <summary>
        /// Function, that converts the selected difficulty from the user into number
        /// </summary>
        ...
        /// <summary>
        /// Function, that get the number of the cells, that should be empty, depending of the difficulty of the game
        /// </summary>
        ...
        /// <summary>
        /// Function, that clears all the cells in the Sudoku
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user clicks the Pause Game Button
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user clicks the Resume Game button
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user wants to see the solution of the game
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user wants to reset the game
        /// </summary>
        ...
        /// <summary>
        /// Function, that fills the cells in the sudoku with the value in the Matrix prop
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user click the undo menu option
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user click the redo menu option
        /// </summary>
        ...
        /// <summary>
        /// Function, that works whenn the user click the Load New Game Button
        /// </summary>
        ...
        /// <summary>
        /// Function, that shows the 9x9 grid with every minigrid in it
        /// </summary>
        ...
        /// <summary>
        /// Function, that hides the 9x9 grid with every minigrid in it
        /// </summary>
        ...
        /// <summary>
        /// Function, that check is the game solved, whenn the user click the Check Solution Button
        /// </summary>
        ...
        /// <summary>
        /// Function, that shows the Game Statistics with the information for the solved games
        /// </summary>
        ...
        /// <summary>
        /// Function, that loads and shows new game, when the user clicks the Load New Game Button
        /// </summary>
...
*/
        ...
        /// <summary>
        /// Function, that makes the cells in a specific string, that is saved in a txt file for next openning
        /// </summary>
        ...
        /// <summary>
        /// Function, that save the game in a txt file for future openning
        /// </summary>
        ...
        /// <summary>
        /// Function, that clears the undo and redo Stacks
        /// </summary>
        ...
        /// <summary>
        /// Function, that opens the New Game Window, from where th user can open saved game
        /// </summary>
        ...
        /// <summary>
        /// OnPropertyChanged Function, for the PropertyChanged delegate
        /// </summary>
